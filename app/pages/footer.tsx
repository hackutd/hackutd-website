...
export default function Footer() {
  return (
    <footer className="w-full pt-10 pb-14 px-4 relative overflow-hidden animated-gradient">
      <div
        aria-hidden
      ...
      />
      {/* Top Row */}
      <div className="flex flex-col md:flex-row justify-between items-center w-full max-w-5xl mx-auto gap-4 relative z-10">
        <span className="text-white text-lg md:text-xl">© 2025 HackUTD by <span className="underline underline-offset-4">ACM UTD</span></span>
        <span className="text-white text-lg md:text-xl">
          Get in Touch: <a href="mailto:hello@hackutd.co" className="underline underline-offset-4">hello@hackutd.co</a>
        </span>
      </div>
      {/* Divider */}
      <hr className="my-8 border-white/60 relative z-10" />
      {/* Bottom Row */}
      <div className="flex flex-col items-center justify-center w-full max-w-5xl mx-auto relative z-10">
        <span className="text-white text-2xl md:text-3xl flex items-center gap-2">
          ...
          <span className="inline-flex items-center justify-center ml-2">
            <Image src="/heart.svg" alt="Heart U" width={36} height={36} />
          </span>
        </span>
      </div>
    </footer>
