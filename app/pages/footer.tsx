  ...
  return (
    <footer className="w-full pt-6 md:pt-10 pb-10 md:pb-14 px-4 relative overflow-hidden animated-gradient">
      ...
      <div className="flex flex-col md:flex-row justify-between items-center w-full max-w-5xl mx-auto gap-3 md:gap-4 relative z-10 text-center md:text-left">
        <span className="text-white text-sm md:text-sm lg:text-base">© 2025 HackUTD by <span className="underline underline-offset-4">ACM UTD</span></span>
        <span className="text-white text-sm md:text-sm lg:text-base">
      ...
      <div className="flex flex-col items-center justify-center w-full max-w-5xl mx-auto relative z-10">
        <span className="text-white text-sm md:text-sm lg:text-xl flex items-center gap-2 text-center">
          There&apos;s no HackUTD...without
          ...
          <span className="align-middle text-base font-bold tracking-tight ml-1">™</span>
        </span>
      </div>
    </footer>
  );
