...
export default function StatCard({
    ...
    return(
        <div
            ...
            "
        >
            <span className="text-[4vw] font-bold leading-none drop-shadow-lg">{title}</span>
            <span className="text-[1.5vw] font-medium text-white/80 mt-2">{subtitle}</span>
            <span className="text-[1.2vw] font-normal text-white/60 mt-1">{body}</span>
        </div>
    );
}